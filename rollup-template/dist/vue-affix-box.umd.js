(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global['rollup-template'] = factory(global.throttleDebounce, global.ResizeObserver));
  ...
  __vue_render__._withStripped = true;
    ...
    const __vue_inject_styles__ = function (inject) {
      if (!inject) return
      inject("data-v-49898be0_0", { source: ".c-affix.is-fixed {\n  position: fixed;\n  z-index: 10;\n}\n", map: {"version":3,"sources":["rollup-template.vue"],"names":[],"mappings":"AAAA;EACE,eAAe;EACf,WAAW;AACb","file":"rollup-template.vue","sourcesContent":[".c-affix.is-fixed {\n  position: fixed;\n  z-index: 10;\n}\n"]}, media: undefined });
  ...
  Object.defineProperty(__vue_component__, 'install', {
    ...
    value: function value(Vue, options) {
      ...
      Vue.component('rollup-template', __vue_component__);
    }
  });
